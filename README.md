...
| 平台 | 文件名后缀 | 适用机型 |
|------|-----------|--------|
| apollolake (x86_64) | `apollolake` | DS920+, DS1522+, DS720+, DS923+, RS822+ 等 Intel/AMD 型号 |
| rtd1296 (aarch64) | `rtd1296` | DS220+, DS723+, DS423+ 等 ARM64 型号 |
| alpine (armv7l) | `alpine` | DS216 等旧款 ARM 机型 |
...
| Platform | File suffix | Compatible Models |
|---|---|---|
| apollolake (x86_64) | `apollolake` | DS920+, DS1522+, DS720+, DS923+, RS822+, etc. |
| rtd1296 (aarch64) | `rtd1296` | DS220+, DS723+, DS423+, etc. |
| alpine (armv7l) | `alpine` | DS216, etc. (older ARM models) |
